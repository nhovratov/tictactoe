...
<section class="container bg-colorWhite">
    ...
    <article id="mainContent">
        ...
        <?php endif; ?>
        <?php Renderer::partial("gamemode", $data) ?>
        <?php Renderer::partial("status", $data) ?>
        <div class="row level1">
            <div class="col-md-offset-4 col-md-4">
                <?php Renderer::partial("tictactoe-board", $data, ['action' => $data['gamemode']]); ?>
            </div>
        </div>
    </article>
</section>
